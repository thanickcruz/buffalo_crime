...
After validating Random Forest models with 50, 100, 500, and 1000 trees, we found that [500 trees minimizes the estimated test error rate at 4%]{.underline}. However, these values were arbitrarily chosen, so lower error rates may occur between these values. In this report, we have chosen to further investigate every model between 1 and 100 trees.
